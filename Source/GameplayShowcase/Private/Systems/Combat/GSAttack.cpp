...
#include "Systems/Combat/GSAttack.h"
...
void UGSAttack::InputReleased(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
	const FGameplayAbilityActivationInfo ActivationInfo)
{	
	if (IsActive())
	{
...
void UGSAttack::OnComboWindowEnd(FGameplayEventData Payload)
{
	...
	MontageTask ? MontageTask->ExternalCancel() : EndAttackAbility();
}
...
void UGSAttack::EndAttackAbility()
{
